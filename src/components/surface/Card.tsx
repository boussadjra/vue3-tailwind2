...
export default defineComponent({
	...
	setup(props, { slots }) {
		...
		return () => (
			<div
				class={`card  min-w-sm border  dark:border-black-600  bg-gray-100 dark:bg-black-600 dark:text-white  transition-shadow ${cardClasses.value}`}
			>

...
// const cardClasses=ref('')
		...
		return () => (
			<div class={`card  min-w-sm border border-gray-100 dark:border-black-600  bg-gray-50 dark:bg-black-600 dark:text-gray-200  transition-shadow ${cardClasses.value}`}>
